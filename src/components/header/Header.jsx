    ...
    <header className=" fixed mx-auto max-w-[var(--breakpoint-xl)] w-full z-50 top-0">
      <div className="max-w-7xl mx-auto px-4 md:py-2 flex justify-between items-center bg-white relative">
        {isDesktop ? (
          <>
            {/* Logo */}
            <div className="lg:flex-none lg:ms-0 ms-20 text-primary flex items-center">
              <GiGraduateCap
                fill="currentColor"
                className="lg:size-20 size-14"
              />
              <span className=" text-[2rem] font-bold">ApplyParrot</span>
            </div>
            ...
            {/* Mobile Nav */}
            <div
              className={`absolute bg-white border border-gray-00 shadow-lg right-0 left-0 p-5 max-w-[var(--breakpoint-xl)] z-0 ${
