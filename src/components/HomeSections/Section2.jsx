...
const Section2 = () => {
  ...
  return (
    <section className="w-full lg:mt-[10rem] 2xl:mt-[2rem] md:mt-[2rem] mt-5">
      <div className="lg:mt-10 ">
        <h3 className="lg:text-[30px] md:text-[26px] font-bold text-gray-600 text-center  lg:w-[500px] justify-self-center ">
